<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['android:users:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['android:users:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="usersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="最近登录时间" align="center" prop="lastLoginTime" width="180">
        <template slot-scope="scope">
...
<script>
import { listUsers, getUsers, delUsers, addUsers, updateUsers } from "@/api/android/users";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        status: [
          { required: true, message: "状态：1=正常，0=禁用不能为空", trigger: "change" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('android/users/export', {
        ...this.queryParams
